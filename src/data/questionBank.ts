...
export const QUESTION_POOL: Question[] = [
  // ================= 心脏筛查赛道 =================
  {
    ...
    categoryId: 'cardiac',
    level: 1,
    title: '请观察该胎儿心脏四腔心切面动态扫查，请诊断该心内结构异常：',
    hint: '注意观察室间隔回声连续性与分流',
    viewType: '四腔心切面 (4CH View)',
    standardAnswer: '室间隔缺损',
    aliases: ['室缺', 'VSD', '膜部室间隔缺损', '肌部室间隔缺损'],
    keywords: ['室间隔', '缺损'],
    explanation: '四腔心切面可见室间隔连续性中断，过隔血流束。',
  },
  {
    id: 'cardiac-102',
    categoryId: 'cardiac',
